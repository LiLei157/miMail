    ...
    <div class="container">
      ...
      <div class="ads-box">
        <div class="ads-item" v-for="(item,index) in adsList" :key="index">
          <a :href="'/#/product/'+item.id"><img :src="item.url"></a>
        </div>
      </div>
      <!-- 广告位下的banner图 -->
      <div class="banner-box">
        <a :href="'/#/product/'+bannerData.id"><img :src="bannerData.url" alt=""></a>
      </div>
    </div>
        ...
        .classify-item{
          a{
            ...
            &::after{
              display: inline-block;
              content: ' ';
              @include bgImg(10px,15px,'/imgs/icon-arrow.png'); // 替换成我们定义的mixin中的bgImg()函数
              position: absolute;
              right: 30px;
